...
def run_episode(*, env, calib: dict[str, Any], policy, task_description: str,
    ...
    for skill_idx, skill_text in enumerate(skill_list):
        ...
        while total_steps < args.episode_length:
            ...
            obs['ee_position'] = project_ee_world_to_pixel(ee_world, calib)
            ee_x, ee_y, ee_depth = obs['ee_position']
            ee_xy_norm = list(pixel_to_normalized_xy(ee_x, ee_y, W, H)) + [ee_depth]
            ...
            if need_replan and trace_frozen:
                ...
                planning_obs = make_planning_obs(obs, skill_ctx, task_description, ee_xy_norm)
            ...
            if should_check:
                exec_obs = make_execution_obs(obs, skill_ctx, task_description, ee_xy_norm, overlay_image)
            ...
            exec_obs = make_execution_obs(obs, skill_ctx, task_description, ee_xy_norm, overlay_image, skill_ctx.cached_trace_xy_norm)
