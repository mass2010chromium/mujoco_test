...
if __name__ == "__main__":
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        if task_id != 5:       # test task 10 --> drawer closed initially
            continue
        ...
        # scene_plan = '1. PICK(black bowl) 2. PLACE(black bowl, top drawer, inside) 3. PICK(chocolate pudding) 4. PLACE(chocolate pudding, top drawer, inside) 3. CLOSE(top drawer)'
        scene_plan = ''
        ...
        for episode_idx in tqdm.tqdm(range(TRIALS_PER_TASK)):
            ...
            mediapy.write_video('franka_libero_v2.mp4', frames, fps=FRAME_RATE)
